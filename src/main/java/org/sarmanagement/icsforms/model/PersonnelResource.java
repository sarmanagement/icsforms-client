 ...
 *
 * <p>
 * Stable identity fields (name, agency, state, phone) belong to this entity.
 * Operational-period-specific values such as radio channel and assigned status
 * are stored in {@link OperationalPeriodAssignment}.
 * </p>
 */
...
public class PersonnelResource extends IncidentResource {
	...
	/**
	 * Convenience factory — creates a personnel resource with the given display
	 * name.
	 *
	 * @param name
