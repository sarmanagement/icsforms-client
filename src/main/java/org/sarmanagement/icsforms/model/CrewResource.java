 ...
 *
 * <p>
 * A crew or team is a collective resource: multiple personnel deploying
 * together under a single unit designation. The total headcount is tracked
 * here; individual team members may also have their own
 * {@link PersonnelResource} records.
 * </p>
 */
...
public class CrewResource extends IncidentResource {
	 ...
	 * Convenience factory.
	 *
	 * @param teamDesignator
	 *            team identifier or name (e.g. "Team Alpha").
	 ...
	 *
	 * @param numberOfPersons
	 *            number of persons (must be &ge; 0).
	 */
