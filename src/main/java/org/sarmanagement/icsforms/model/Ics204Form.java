...
public class Ics204Form {
	...
	/**
	 * Returns the stable form identifier used to link ICS 214 activity logs to this
	 * form.
	 *
	...
	public boolean requiresBranchDivisionGroupSupervisor() {
		return MANAGEMENT_BRANCH.equals(getManagementContext()) || MANAGEMENT_DIVISION.equals(getManagementContext())
				|| MANAGEMENT_GROUP.equals(getManagementContext());
	}

	/**
	 * Returns whether the required supervisor data is present when context requires
	 * it.
	 *
	...
	public String getManagementContext() {
		if (MANAGEMENT_BRANCH.equals(managementContext) || MANAGEMENT_DIVISION.equals(managementContext)
	 ...
	 *            selected management context key.
	 */
	...
	public String getSecondaryManagementContact() {
		return MANAGEMENT_BRANCH.equals(getManagementContext())
				...
				: divisionGroupSupervisorContact;
	}
	 ...
	 *
	 * @param divisionGroupSupervisorName
	 *            supervisor name.
	 */
	 ...
	 *
	 * @param divisionGroupSupervisorContact
	 *            supervisor contact.
	 */
	 ...
	 *
	 * @param sharedWorkAssignment
	 *            shared assignment text.
	 */
