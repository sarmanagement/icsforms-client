...
/**
 * Canonical aircraft resource — ICS 219-4 Helicopter (blue) or 219-6 Fixed-Wing
 * / UAS (orange).
 *
 * <p>
 * The {@link #getAircraftCategory()} discriminates between the two card
 * colours. The designated pilot or operator is tracked via
 * {@link #getPilotResourceId()}.
 * </p>
 */
...
public class AircraftResource extends IncidentResource {
	...
	public enum AircraftCategory {
		...
		HELICOPTER,
		/**
		 * ICS 219-6 — Fixed-wing aircraft and unmanned aerial systems / drones
		 * (orange).
		 */
		FIXED_WING
	}
	...
	/**
	 * {@code resourceId} of the {@link PersonnelResource} who is the primary pilot
	 * or operator of this aircraft. Blank when no pilot has been linked.
	 */
	private String pilotResourceId = "";

	/**
	 * Cached display name of the pilot, for rendering convenience. Canonical value
	 * lives in the pilot's {@link PersonnelResource}.
	 */
	 ...
	 *
	 * @param identifier
	 *            tail number, call sign, or UAS identifier.
	 * @param aircraftCategory
	 *            helicopter or fixed-wing/UAS.
	 ...
	 *
	 * @param aircraftCategory
	 *            aircraft category; {@code null} treated as
	 ...
	 *
	 * @param pilotResourceId
	 *            pilot resource ID; {@code null} treated as blank.
	 */
	 ...
	 *
	 * @param pilotDisplayName
	 *            pilot display name; {@code null} treated as blank.
	 */
