...
public class SarTaskAssignment {
	 ...
	 *
	 * <p>
	 * Values: {@code "planned"} (default),
	 * {@code "assigned - enroute to assignment"}, {@code "assigned - on task"},
	 * {@code "assigned - returning from assignment"}, {@code "returned"} (resources
	 * Out of Service or Available depending on incident configuration).
	 * </p>
	 */
	 ...
	 *
	 * <p>
	 * A debriefing is considered complete when the supervisor has been named and
	 * the debrief notes, areas-not-covered, and hazards-observed fields are all
	 * non-blank. This flag must be explicitly set by the operator via the debrief
	 * editor.
	 * </p>
	 */
	 ...
	 *            ICS 204 resource assignment.
	 * @param incidentContext
	 *            shared incident context.
	 * @param form204
	 *            containing ICS 204 form.
	 * @return SAR task scaffold record.
	 */
	public static SarTaskAssignment fromResourceAssignment(ResourceAssignment resourceAssignment,
			IncidentContext incidentContext, Ics204Form form204) {
		...
		if (resourceAssignment != null) {
			...
			task.setAssignment(
					resourceAssignment.getAssignment() == null || resourceAssignment.getAssignment().isBlank()
			...
			task.setSpecialEquipment(
					joinNonBlank(resourceAssignment.getSpecialEquipment(), resourceAssignment.getSupplies()));
	...
	public void setStagingArea(String stagingArea) {
		this.stagingArea = stagingArea == null ? "" : stagingArea;
	}
	...
	/**
	 * @param operationsSectionChiefName
	 *            operations section chief name.
	 */
	public void setOperationsSectionChiefName(String operationsSectionChiefName) {
		this.operationsSectionChiefName = operationsSectionChiefName == null ? "" : operationsSectionChiefName;
	}
	...
	/**
	 * @param operationsSectionChiefContact
	 *            operations section chief contact.
	 */
	...
	public String getSecondaryManagementRoleLabel() {
		return secondaryManagementRoleLabel;
	}
	/**
	 * @param secondaryManagementRoleLabel
	 *            secondary management role label.
	 */
	public void setSecondaryManagementRoleLabel(String secondaryManagementRoleLabel) {
		this.secondaryManagementRoleLabel = secondaryManagementRoleLabel == null ? "" : secondaryManagementRoleLabel;
	}
	/** @return secondary management name. */
	public String getSecondaryManagementName() {
		return secondaryManagementName;
	}
	/**
	 * @param secondaryManagementName
	 *            secondary management name.
	 */
	public void setSecondaryManagementName(String secondaryManagementName) {
		this.secondaryManagementName = secondaryManagementName == null ? "" : secondaryManagementName;
	}
	/** @return secondary management contact. */
	public String getSecondaryManagementContact() {
		return secondaryManagementContact;
	}
	/**
	 * @param secondaryManagementContact
	 *            secondary management contact.
	 */
	public void setSecondaryManagementContact(String secondaryManagementContact) {
		this.secondaryManagementContact = secondaryManagementContact == null ? "" : secondaryManagementContact;
	}
	...
	/**
	 * @param transportationInstructions
	 *            transportation instructions.
	 */
	public void setTransportationInstructions(String transportationInstructions) {
		this.transportationInstructions = transportationInstructions == null ? "" : transportationInstructions;
	}
	...
	public void setSpecialEquipment(String specialEquipment) {
		this.specialEquipment = specialEquipment == null ? "" : specialEquipment;
	}
	...
	/**
	 * @param preparedByPositionTitle
	 *            assignment-side preparer title.
	 */
	...
	public java.time.LocalDateTime getPreparedDateTime() {
		return preparedDateTime;
	}
	/**
	 * @param preparedDateTime
	 *            assignment-side prepared date/time.
	 */
	public void setPreparedDateTime(java.time.LocalDateTime preparedDateTime) {
		this.preparedDateTime = preparedDateTime;
	}
	/** @return debriefing supervisor. */
	public String getDebriefingSupervisor() {
		return debriefingSupervisor;
	}
	/**
	 * @param debriefingSupervisor
	...
	/**
	 * @param assignmentStart
	 *            assignment start.
	 */
	public void setAssignmentStart(java.time.LocalDateTime assignmentStart) {
		this.assignmentStart = assignmentStart;
	}
	/** @return assignment end. */
	public java.time.LocalDateTime getAssignmentEnd() {
	 ...
	 *            assignment end.
	 */
	public void setAssignmentEnd(java.time.LocalDateTime assignmentEnd) {
	...
	public void setVehicleMiles(String vehicleMiles) {
		this.vehicleMiles = vehicleMiles == null ? "" : vehicleMiles;
	}
	/** @return debrief notes. */
	public String getDebriefNotes() {
		return debriefNotes;
	}
	/**
	 * @param debriefNotes
	 *            debrief notes.
	 */
	public void setDebriefNotes(String debriefNotes) {
		this.debriefNotes = debriefNotes == null ? "" : debriefNotes;
	}
	/** @return reported POD percent. */
	public String getReportedPod() {
		return reportedPod;
	}
	/**
	 * @param reportedPod
	 *            reported POD percent.
	 */
	public void setReportedPod(String reportedPod) {
		this.reportedPod = reportedPod == null ? "" : reportedPod;
	}
	/** @return areas not covered notes. */
	public String getAreasNotCovered() {
		return areasNotCovered;
	}
	/**
	 * @param areasNotCovered
	 *            areas not covered notes.
	 */
	public void setAreasNotCovered(String areasNotCovered) {
		this.areasNotCovered = areasNotCovered == null ? "" : areasNotCovered;
	}
	...
	/**
	 * @param hazardsObserved
	 *            hazards observed notes.
	 */
	public void setHazardsObserved(String hazardsObserved) {
		this.hazardsObserved = hazardsObserved == null ? "" : hazardsObserved;
	}
	/** @return canine resource subtype. */
	public String getCanineSearchType() {
		return canineSearchType;
	}
	/**
	 * @param canineSearchType
	 *            canine resource subtype.
	 */
	public void setCanineSearchType(String canineSearchType) {
		this.canineSearchType = canineSearchType == null ? "" : canineSearchType;
	}
	/** @return canine imprint. */
	public String getCanineImprint() {
		return canineImprint;
	}
	/**
	 * @param canineImprint
	 *            canine imprint.
	 */
	public void setCanineImprint(String canineImprint) {
		this.canineImprint = canineImprint == null ? "" : canineImprint;
	}
	/** @return canine sun angle notes. */
	public String getCanineSunAngle() {
		return canineSunAngle;
	}
	/**
	 * @param canineSunAngle
	 *            canine sun angle notes.
	 */
	public void setCanineSunAngle(String canineSunAngle) {
		this.canineSunAngle = canineSunAngle == null ? "" : canineSunAngle;
	}
	/** @return canine day/night notes. */
	public String getCanineDayNight() {
		return canineDayNight;
	}
	/**
	 * @param canineDayNight
	 *            canine day/night notes.
	 */
	public void setCanineDayNight(String canineDayNight) {
		this.canineDayNight = canineDayNight == null ? "" : canineDayNight;
	}
	/** @return canine cloud cover notes. */
	public String getCanineCloudCover() {
		return canineCloudCover;
	}
	/**
	 * @param canineCloudCover
	 *            canine cloud cover notes.
	 */
	public void setCanineCloudCover(String canineCloudCover) {
		this.canineCloudCover = canineCloudCover == null ? "" : canineCloudCover;
	}
	/** @return canine wind speed notes. */
	public String getCanineWindSpeed() {
		return canineWindSpeed;
	}
	/**
	 * @param canineWindSpeed
	 *            canine wind speed notes.
	 */
	public void setCanineWindSpeed(String canineWindSpeed) {
		this.canineWindSpeed = canineWindSpeed == null ? "" : canineWindSpeed;
	}
	/** @return qualitative POD factors. */
	public List<PodFactorRating> getQualitativePodFactors() {
		return qualitativePodFactors;
	}
	/**
	 * @param qualitativePodFactors
	 *            qualitative POD factors.
	 */
	...
	public String getDebriefPreparedByName() {
		return debriefPreparedByName;
	}
	/**
	 * @param debriefPreparedByName
	 *            debrief prepared by name.
	 */
	public void setDebriefPreparedByName(String debriefPreparedByName) {
		this.debriefPreparedByName = debriefPreparedByName == null ? "" : debriefPreparedByName;
	}
	/** @return debrief prepared by title. */
	public String getDebriefPreparedByPositionTitle() {
		return debriefPreparedByPositionTitle;
	}
	/**
	 * @param debriefPreparedByPositionTitle
	 *            debrief prepared by title.
	 */
	public void setDebriefPreparedByPositionTitle(String debriefPreparedByPositionTitle) {
		this.debriefPreparedByPositionTitle = debriefPreparedByPositionTitle == null
				? ""
				: debriefPreparedByPositionTitle;
	}
	/** @return debrief prepared date/time. */
	public java.time.LocalDateTime getDebriefPreparedDateTime() {
		return debriefPreparedDateTime;
	}
	/**
	 * @param debriefPreparedDateTime
	 *            debrief prepared date/time.
	 */
	public void setDebriefPreparedDateTime(java.time.LocalDateTime debriefPreparedDateTime) {
		this.debriefPreparedDateTime = debriefPreparedDateTime;
	}
	/**
	 ...
	 */
	public String getTaskLifecycleStatus() {
		return normalizeLifecycle(taskLifecycleStatus);
	}
	/**
	 * Sets the task lifecycle status.
	 *
	 * @param taskLifecycleStatus
	 *            lifecycle status; null treated as "planned".
	 */
	 ...
	 */
	public boolean isDebriefingCompleted() {
		return debriefingCompleted;
	}

	/**
	 * Sets the debriefing-completed flag.
	 *
	 * @param debriefingCompleted
	 *            {@code true} to mark as complete.
	 */
	...
	public String getIapPage() {
		return iapPage == null ? "" : iapPage;
	}
	/**
	 * @param iapPage
	 *            IAP page number string.
	 */
