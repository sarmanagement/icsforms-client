 ...
 *
 * <p>
 * Each log is associated with at most one other data object through a typed
 * relationship: an ICS 204 assignment list (referenced by
 * {@link #linkedIcs204FormId}) or a SAR task assignment (referenced by
 * {@link #linkedSarTaskAssignmentId}). When neither reference is set the log
 * belongs to the ICP/command-post level. The operational scope is derived from
 * these typed fields via {@link #getLogScope()}.
 * </p>
 */
...
public class Ics214Form {
	...
	/**
	 * Stable UUID of the {@link org.sarmanagement.icsforms.model.TCard} linked to
	 * section 3 (Name) of this form. When set, {@link #homeAgency} and
	 * {@link #icsPosition} are resolved from the canonical resource on load so role
	 * and home agency stay in sync.
	 */
	 ...
	 *
	 * <ul>
	 * <li>{@link ActivityLogScope#TASK_ASSIGNMENT} when
	 * {@link #linkedSarTaskAssignmentId} is set.</li>
	 * <li>{@link ActivityLogScope#ASSIGNMENT_LIST} when {@link #linkedIcs204FormId}
	 * is set.</li>
	...
	/**
	 * Returns the {@link org.sarmanagement.icsforms.model.Ics204Form#getFormId()
	 * formId} of the ICS 204 assignment list associated with this log, or an empty
	 * string when not linked.
	 *
	...
	/**
	 * Sets the ICS 204 form identifier for an assignment-list-scoped log. Clears
	 * {@link #linkedSarTaskAssignmentId} so the two typed references stay mutually
	 * exclusive.
	 *
	 * @param linkedIcs204FormId
	 *            ICS 204 form identifier, or {@code null}/blank to clear.
	 */
	...
	/**
	 * Returns the {@link SarTaskAssignment#getAssignmentId() assignmentId} of the
	 * SAR task assignment associated with this log, or an empty string when not
	 * linked.
	 *
	 ...
	 * Clears {@link #linkedIcs204FormId} so the two typed references stay mutually
	 * exclusive.
	 *
	 * @param linkedSarTaskAssignmentId
	 *            SAR task assignment identifier, or {@code null}/blank to clear.
	 */
	...
	/**
	 * Returns the stable UUID of the {@link org.sarmanagement.icsforms.model.TCard}
	 * linked to section 3 (Name) of this form, or blank when not linked.
	 *
	 ...
	 *            resource UUID; {@code null} treated as blank.
	 */
	 ...
	 *            section 8 preparer position/title.
	 */
	 ...
	 *
	 * @param preparedBySignature
	 *            section 8 preparer signature text.
	 */
