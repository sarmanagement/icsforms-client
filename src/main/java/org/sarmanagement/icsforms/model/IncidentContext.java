...
public class IncidentContext {
	 ...
	 *
	 * @param incidentName
	 *            incident name shown on all forms.
	 * @param operationalPeriodStart
	 *            operational period start date/time.
	 * @param operationalPeriodEnd
	 *            operational period end date/time.
	 * @param currentUser
	 *            preparer or current user identity.
	 * @param currentUserPositionTitle
	 *            preparer position/title.
	 */
	public IncidentContext(String incidentName, LocalDateTime operationalPeriodStart,
			LocalDateTime operationalPeriodEnd, String currentUser, String currentUserPositionTitle) {
