 ...
 *
 * <p>
 * In ICS, search canines are treated as working assets/equipment, not as
 * personnel. This class carries the canine's own identity fields plus a link to
 * the {@link PersonnelResource} who is the handler or operator. The handler's
 * name is stored here for display convenience; the authoritative handler record
 * is the {@link PersonnelResource} identified by
 * {@link #getHandlerResourceId()}.
 * </p>
 */
...
public class CanineResource extends IncidentResource {
	...
	/**
	 * {@code resourceId} of the {@link PersonnelResource} that is the primary
	 * handler or operator of this canine. Blank when no handler has been linked
	 * yet.
	 */
	 ...
	 * {@link PersonnelResource#getDisplayName()} for convenience in rendering. This
	 * is display-only; the canonical value is in the handler's PersonnelResource.
	 */
	...
	/**
	 * Convenience factory — creates a canine resource with the given call-sign /
	 * name.
	 *
	 * @param canineName
	 *            the canine's name or call-sign (e.g. "K9-Ranger").
	...
	/**
	 * Returns the {@code resourceId} of the handler {@link PersonnelResource}, or
	 * blank if none has been linked.
	 *
	 ...
	 *
	 * @param handlerResourceId
	 *            handler resource ID; {@code null} treated as blank.
	 */
	 ...
	 *
	 * @param handlerDisplayName
	 *            handler display name; {@code null} treated as blank.
	 */
	 ...
	 *
	 * @param breed
	 *            breed; {@code null} treated as blank.
	 */
	 ...
	 *
	 * @param imprint
	 *            imprint type; {@code null} treated as blank.
	 */
