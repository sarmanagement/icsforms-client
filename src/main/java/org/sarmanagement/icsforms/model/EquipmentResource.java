...
/**
 * Canonical ground-equipment resource — covers ICS 219-3 Engine (rose), 219-7
 * Equipment (yellow, non-canine), and 219-8 Miscellaneous Equipment (tan).
 *
 * <p>
 * An equipment resource may have zero or one designated operator/handler
 * tracked via {@link #getOperatorResourceId()}. The {@link #getTCardType()}
 * returns the appropriate 219 card type based on the
 * {@link #getEquipmentCategory()} set at creation.
 * </p>
 */
...
public class EquipmentResource extends IncidentResource {
	...
	/**
	 * {@code resourceId} of the {@link PersonnelResource} who is the primary
	 * operator or handler of this equipment. Blank when no operator has been
	 * linked.
	 */
	private String operatorResourceId = "";

	/**
	 * Cached display name of the operator, for rendering convenience. Canonical
	 * value lives in the operator's {@link PersonnelResource}.
	 */
	 ...
	 *            equipment category; {@code null} treated as
	 ...
	 *
	 * @param operatorResourceId
	 *            operator resource ID; {@code null} treated as blank.
	 */
	 ...
	 *            operator display name; {@code null} treated as blank.
	 */
