...
public final class SarTaskSupport {
	...
	private static final List<String> RESOURCE_TYPES = List.of("", RESOURCE_TYPE_CANINE, RESOURCE_TYPE_EQUINE,
			RESOURCE_TYPE_GROUND, RESOURCE_TYPE_TECHNICAL, RESOURCE_TYPE_AIR, RESOURCE_TYPE_WATER);
	...
	private static final List<PodFactorTemplate> HUMAN_GROUND_FACTORS = List.of(
			new PodFactorTemplate("Hazards Observed", 10, false), new PodFactorTemplate("Terrain", 10, true),
			new PodFactorTemplate("Vegetation", 10, true), new PodFactorTemplate("Weather", 10, true),
			new PodFactorTemplate("Team Composition", 10, true), new PodFactorTemplate("Light", 10, true),
			new PodFactorTemplate("Area Size", 10, true), new PodFactorTemplate("Tactics", 10, true),
	...
	private static final List<PodFactorTemplate> CANINE_FACTORS = List.of(
			new PodFactorTemplate("Hazards Observed", 5, false), new PodFactorTemplate("Wind", 10, true),
			new PodFactorTemplate("Humidity", 10, true), new PodFactorTemplate("Vegetation", 10, true),
			new PodFactorTemplate(CANINE_SWEEP_WIDTH_PATTERN, 10, true),
			new PodFactorTemplate("Team Wellness", 10, true), new PodFactorTemplate("Contamination", 10, true),
			new PodFactorTemplate(CANINE_HANDLER_CERTIFICATION_FACTOR_NAME, 5, true),
			new PodFactorTemplate("Light", 5, true), new PodFactorTemplate("Weather/Temperature", 5, true),
			new PodFactorTemplate("Terrain Features", 5, true),
			new PodFactorTemplate("Area Size/Time Allotment", 5, true), new PodFactorTemplate("Team Fatigue", 5, true),
	...
	private static final List<PodFactorTemplate> EQUINE_FACTORS = List.of(
			...
			new PodFactorTemplate("Mount Experience", 10, true), new PodFactorTemplate("Mount Management", 10, true),
			new PodFactorTemplate("Terrain", 10, true), new PodFactorTemplate("Vegetation", 10, true),
			new PodFactorTemplate("Contamination", 5, true),
			new PodFactorTemplate("Rider SAR Training/Certification", 5, true), new PodFactorTemplate("Light", 5, true),
			new PodFactorTemplate("Weather", 5, true), new PodFactorTemplate("Fatigue", 5, true),
			new PodFactorTemplate("Humidity", 5, true), new PodFactorTemplate("Area Features", 5, true),
			new PodFactorTemplate("Wind", 5, true), new PodFactorTemplate("Other Variables", 5, true));
